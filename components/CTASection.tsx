      ...
      <section className="relative overflow-hidden bg-ink">
        ...
        <div className="container-x relative grid items-start gap-10 py-16 sm:py-20 lg:grid-cols-[1fr_0.9fr]">
          <div className="lg:pt-2">
            ...
            <h2 className="mt-3 font-display text-3xl font-bold text-white sm:text-4xl">{heading}</h2>
            ...
            <p className="mt-6 max-w-lg text-white/85">{sub}</p>
            {pitch && <p className="mt-4 max-w-lg text-white/85">{pitch}</p>}
            <a
              href={site.phoneHref}
              className="btn-ghost mt-6 !border-ink-700 !bg-transparent !text-white hover:!border-white"
            >
              Call {site.phone}
            </a>
          </div>
  ...
  return (
    <section className="relative overflow-hidden bg-ink">
      ...
      <div className="container-x relative flex flex-col items-center gap-6 py-16 text-center sm:py-20">
        <p className="eyebrow">{site.headline}</p>
        <h2 className="max-w-2xl font-display text-3xl font-bold text-white sm:text-4xl">{heading}</h2>
        <p className="max-w-xl text-white/85">{sub}</p>
        <div className="flex flex-col gap-3 sm:flex-row">
          <Link href="/consult" className="btn-primary">
            Book a Free Consult
          </Link>
          <a href={site.phoneHref} className="btn-ghost !bg-transparent !text-white !border-ink-700 hover:!border-white">
            Call {site.phone}
          </a>
        </div>
      </div>
