...
export default function StepNav({ steps }: { steps: Step[] }) {
  ...
  return (
    ...
    >
      {/* lg:pl-32 keeps the centred steps clear of the header logo, which
          overhangs the bar on desktop and paints above this one. */}
      <div className="container-x flex flex-wrap justify-center gap-x-8 gap-y-2 py-4 font-sans text-xs uppercase tracking-[0.25em] lg:pl-32">
        {steps.map((s) => {
